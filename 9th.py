...
dataset = pd.read_csv(r"C:\machine learning programs\lab\DATASET\DATASET\breastcancer.csv")
...
"""
Note: This code block does not do anything, it just displays the default hyperparameters for the model.
"""
